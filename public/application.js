...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSelectTile = function onSelectTile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  store.game.cell = {};
	  ...
	  $(this).off();
	  api.updateGame(data).then(ui.selectTileSuccess).catch(ui.selectTileFailure);
	...
	var onRestartGame = function onRestartGame(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.startGame(data).then(ui.restartGameSuccess).catch(ui.restartGameFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  api.getIndex().then(getStatsSuccess).catch(getStatsFailure);
	};
	...
	var gameOverUI = function gameOverUI() {
	  if (whoWon === 'Nobody') {
	    $('.gameboard').hide();
	    $('.tie').show();
	...
	var selectTileSuccess = function selectTileSuccess() {
	...
	var selectTileFailure = function selectTileFailure(error) {
	  $('.errormsg').hide();
	...
	module.exports = {
	  ...
	  selectTileSuccess: selectTileSuccess,
	  selectTileFailure: selectTileFailure,
